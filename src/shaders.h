...
private:
    ...
    void compile_shader(const char* vertex_shader_str,const char* fragment_shader_str){
        ...
        glShaderSource(vertex, 1, &vertex_shader_str, NULL);
        glCompileShader(vertex);
        checkCompileErrors(vertex, "VERTEX");
        // fragment Shader
        fragment = glCreateShader(GL_FRAGMENT_SHADER);
        glShaderSource(fragment, 1, &fragment_shader_str, NULL);
...
public:
    ...
    ShaderPlus(const char* vertex_shader_str,const char* fragment_shader_str,bool flag){
        compile_shader(vertex_shader_str,fragment_shader_str);
    }
    ShaderPlus(const char* vertexPath, const char* fragmentPath)
    {
        ...
        compile_shader(vertexCode.c_str(),fragmentCode.c_str());
